...
namespace TestingSorting
{
    ...
    public class Example
    {
        public static void Main()
        {
            ...
            List<CityInfo> listCities = new List<CityInfo>() { NYC, Det, Paris };
            ...
            listCities.Sort(CityInfo.CompareByName);
            DisplayList(listCities);

            // Sort array by population.
            Array.Sort(cities, CityInfo.CompareByPopulation);
            DisplayArray(cities);

            listCities.Sort(CityInfo.CompareByPopulation);
            DisplayList(listCities);
        ...
        private static void DisplayList(List<CityInfo> cities)
        {
